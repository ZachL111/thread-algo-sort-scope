"""Regression checks for the thread-algo-sort-scope casebook."""
...
from casebook.harness import assert_expected, thread_algo_sort_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_algo_sort_scope_summary(), assert_expected())
