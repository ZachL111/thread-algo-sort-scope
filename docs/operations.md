...
`thread-algo-sort-scope` is centered on algorithms work in OCaml. The technical target is: Package an OCaml local lab for sort analysis with deny and allow fixtures, explainable decision traces, and documented operating limits.
